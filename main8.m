...
'Isoelectric_line';
'Brace_sleeve_screw'};
[classifier_bbx, WIDTH, HEIGHT, gtids]=annotation_read();
%%
...
load('output1/classifier_bbx.mat')
...
for class = 1:length(classifier_bbx) % 生成左右、上下变换后的矩形框
    classifier_bbx2{class}(:,[3:6]) = [WIDTH{class}(:)-classifier_bbx{class}(:,5),classifier_bbx{class}(:,4),WIDTH{class}(:)-classifier_bbx{class}(:,3),classifier_bbx{class}(:,6)];
    classifier_bbx3{class}(:,[3:6]) = [classifier_bbx{class}(:,3),HEIGHT{class}(:)-classifier_bbx{class}(:,6),classifier_bbx{class}(:,5),HEIGHT{class}(:)-classifier_bbx{class}(:,4)];
    classifier_bbx4{class}(:,[3:6]) = [WIDTH{class}(:)-classifier_bbx{class}(:,5),HEIGHT{class}(:)-classifier_bbx{class}(:,6),WIDTH{class}(:)-classifier_bbx{class}(:,3),HEIGHT{class}(:)-classifier_bbx{class}(:,4)];
end
